...
<section class="container" itemscope itemtype="https://schema.org/DataPolicySection">
	<div class="px-3">
		<h1 class="my-4 text-center text-2xl font-semibold">Политика за използване на бисквитките</h1>
		{#await data.terms}
